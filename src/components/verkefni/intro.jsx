  ...
  return (
    <section id="verkefni-intro" className="relative mx-auto max-w-6xl px-6 pt-20 pb-8">
      <header className="text-center">
        <h1 className="text-4xl sm:text-7xl font-bold mb-15">
        ...
        <h2 className="text-3xl sm:text-5xl font-bold tracaking-wide text-white
          ...
          Spor gerir íþróttir að upplifun
        </h2>

        <p className="mt-4 text-white/70 max-w-2xl mx-auto text-2xl
                      opacity-0 translate-y-3 will-change-[transform,opacity]
                      animate-[fadeUpSoft_1200ms_cubic-bezier(0.22,0.61,0.36,1)_1400ms_forwards]">
        ...
        <div className="mx-auto mt-8 h-px w-44 bg-gradient-to-r from-transparent via-[#FEE715]/60 to-transparent
                        ...
                        animate-[fadeIn_1000ms_ease-out_1400ms_forwards]" />
      </header>
    </section>
  );
}
