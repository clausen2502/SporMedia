...
export default function Footer() {
  return (
    <footer className="container mx-auto px-6 py-10 grid gap-8 md:grid-cols-3 text-center md:text-left">
      ...
      <div>
        <h4 className="font-semibold text-lg text-[var(--color--dark_brown)] mb-3">Flýtileiðir</h4>
      ...
      <div>
        <h4 className="font-semibold text-lg text-[var(--color--dark_brown)] mb-3">Hafðu samband</h4>
